...
<div class="button-container">
    <a href="{{ route('teacher.create') }}" class="button sel" id="subject">
        <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 1024 1024" class="icon"
                version="1.1">
                <path
                ...
                <path d="M491.3 200.1h40v667.5h-40z" fill="#387ADF" />
                <path
        ...
        <div class="text">زیادکردنی مامۆستا</div>
    </a>
